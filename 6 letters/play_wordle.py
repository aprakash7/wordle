...
def main():
	word_set= load_data_set(r'data/wordle_words6.txt') #set path
	...
	while wordle.can_attempt:
		...
		if not x in word_set:
			print(
				Fore.RED+ f"NOTE: If it is a valid word, please note that this dataset consists of only 1488 words."+
